    ...
    <div class="container px-5 py-12 mx-auto">
        ...
        @foreach ( $listings as $listing)
                ...
                >
                    ...
                    <span class="md:flex-grow flex flex-col items-center justify-end">

                        <span>{{ $listing->created_at->diffForHumans() }}</span>
                        {{-- Number of Clicks to our apply link associated to this listing --}}
                        <span>
                            <strong class="text-bold">{{ $listing->clicks()->count() }}</strong> Apply Button Clicks
                        </span>
