<footer class="text-gray-600 body-font">
    ...
    <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        ...
        <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
            by <a href="https://aschmelyun.com" class="hover:text-gray-900" target="_blank" rel="noopener">@robingabor</a> &mdash; with <a href="https://tailblocks.cc" class="hover:text-gray-900" target="_blank" rel="noopener">tailblocks.cc</a>
        </p>
        <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            ...
            <a href="" target="_blank" rel="noopener" class="ml-3 text-gray-500 hover:text-gray-900">
                <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
